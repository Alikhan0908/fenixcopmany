...
const counterBlog = [
	{icon: <i className="ti-bag m-r10" />, num: '15',  title: 'yildan beri biznesdamiz',},	
	{icon: <i className="ti-user m-r10" />, num: '700',    title: 'mamnun mijozlar',},	
	{icon: <i className="flaticon-users m-r10" />, num: '50',   title: 'Texnik Ekspertlar',},	
	{icon: <i className="ti-mobile m-r10" />, num: '200', title: 'ilova topshirildi',},	
];
