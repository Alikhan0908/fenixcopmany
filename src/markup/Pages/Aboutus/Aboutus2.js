...
import work1 from './../../../images/about-us/problem.jpg';
import work3 from './../../../images/about-us/approach.jpg';
...
const counterBlog = [
	{icon: <i className="icon flaticon-bar-chart text-primary" />, num: '50',  title: 'Bajarilgan loyihalar',},	
	{icon: <i className="icon flaticon-avatar text-primary" />, num: '74',    title: 'Mamnun mijozlar',},	
	{icon: <i className="icon flaticon-file text-primary" />, num: '2296',   title: 'Savollarga javob berildi',},	
	{icon: <i className="icon flaticon-pen text-primary" />, num: '290', title: 'Buyurtmalar',},	
];
