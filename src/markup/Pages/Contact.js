                                        ...
                                        <div className="col-lg-12 col-md-6 m-b30 ">
                                            <div className="icon-bx-wraper bx-style-1 p-a20 radius-sm">
                                                <div className="icon-content">
                                                    ...
                                                    <p className="m-b0">fenixcompanyuzb@gmail.com</p>
                                                    <p className="m-b0">t.me/fenixcompany_uz</p>
                                                    <p className="m-b0">instagram.com/fenixcompany.uz</p>
                                                    <p>facebook.com/fenixcompany.uz</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-12 col-md-6 m-b30 ">
