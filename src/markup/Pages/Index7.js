...
import Otajon_pic from './../../images/testimonials/Otajon_pic.png';
...
const expertBox = [
	...
	{image: Shexroz_pic, name:'Bobur Axmadjonov', role : 'Marketolog', }, 
	{image: Shexroz_pic, name:'Shexroz Dehqonov', role : 'Grafik Dizayner', }, 
	{image: Samandar_pic, name:'Xasanxonov Alixon', role : 'Frontend Developer', }, 
	{image: Samandar_pic, name:'Xukumov Xusan', role : 'Mobile Developer', }, 
									...
									<div className="col-lg-4 col-md-6 col-sm-6" key={index}>
										<div className="experts-box text-white p-a20" > 
											...
											<ul className="dez-social-icon">
												<li><a href='http://Facebook.com/fenixcompany.uz' className="fa text-white fa-facebook"></a></li>
												<li><a href='http://Instagram.com/fenixcompany.uz' className='fa text-white fa-instagram'></a></li>
												<li><a href='http://T.me/fenixcompany_uz' className='fa text-white fa-telegram'></a></li>
												<li><a href='fenixcompanyuz@gmail.com' className='fa text-white fa-google-plus'></a></li>
											</ul>
										</div>
									</div>
								))}
                            ...
                            <div className="row d-flex align-items-center">
                                ...
                                <div className="col-lg-5">
                                    <div className="contact-info-bx p-a30 text-white" >
                                        ...
                                        <div className="m-b10">
                                            <span>E-mail</span>
                                            <h3>fenixcompanyuzb@gmail.com</h3>
                                        </div>
                                        <div className="m-b10">
                                            <span>Telefon</span>
                                        ...
                                        <div className="m-b10">
                                            ...
                                            <ul className="list-inline socail-icon m-t15 m-a0">
                                                <li><a href='http://Facebook.com/fenixcompany.uz' className="site-button white facebook"><i className="fa fa-facebook"></i></a></li>
                                                <li><a href='http://Instagram.com/fenixcompany.uz' className="site-button white instagram"><i className="fa fa-instagram"></i></a></li>
